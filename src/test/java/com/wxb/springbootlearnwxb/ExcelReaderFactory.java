...
public class ExcelReaderFactory {
     ...
     *           文件输入流
     * @param customContent
     *           自定义模型可以在 com.alibaba.excel.read.event.AnalysisEventListener#invoke(java.lang.Object, com.alibaba.excel.read.context.AnalysisContext)
     *           {@link AnalysisEventListener#invoke(java.lang.Object, com.alibaba.excel.read.context.AnalysisContext) }
    ...
    public static ExcelReader getExcelReader(InputStream in, Object customContent,
        ...
        System.out.println("header8"+header8.toString());
        ...
        System.out.println("excelTypeEnum "+excelTypeEnum);
     ...
     * @param customContent
     *           自定义模型可以在
     *           {@link AnalysisEventListener#(java.lang.Object, com.alibaba.excel.read.context.AnalysisContext) }
     *           AnalysisContext中获取用于监听者回调使用
     * @param eventListener
     *           用户监听
     * @param trim
